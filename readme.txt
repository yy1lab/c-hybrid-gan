...
C-hybrid-GAN originally developed in [Conditional Hybrid GAN for Sequence Generation](https://arxiv.org/abs/2009.08616).

Modifications to include conditioning on seed melodies performed by Karol Lasocki, for the Master's thesis "Deep learning for continuous symbolic melody generation conditioned on lyrics and initial melodies", submitted for evaluation at Aalto University in July 2023.
